<template>
  ...
  <div class="nav-container page-component">
      ...
      <div class="order-detail">
        ...
        <div class="status-bar">
          ...
          <div class="right-wrapper">
            ...
            <div class="content-wrapper">
              <div>
                微信<span class="iconfont"></span>关注“牧医通网上预约挂号”
              </div>
        ...
        <div class="rule-wrapper mt40">
          ...
          <div>
            ...
            ，逾期将不可办理退号退费；<br />
            4、牧医通网上预约挂号支持自费患者使用身份证预约，同时支持郑州市医保患者使用郑州社保卡在平台预约挂号。请于就诊当日，携带预约挂号所使用的有效身份证件到院取号；<br />
    ...
    <!-- 微信支付二维码弹出框 -->
    <el-dialog
      :visible.sync="dialogPayVisible" style="text-align: left" :append-to-body="true" width="500px" @close="closeDialog">
      <div class="container">
